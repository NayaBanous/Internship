...
statfile="/home/guest/BIT11/Internship/PRS/Compute-PRS/Quality-control-testdata/Output/2-Basic-statistics-test-output.stats"
missingfile="/home/guest/BIT11/Internship/PRS/Compute-PRS/Quality-control-testdata/Output/2-Basic-statistics-test-output.missing"
...
MAF_hist <- hist(stats_table$MAF, main ="Distribution of MAF", xlab = "MAF", xlim = range(0,0.5))
...
write.table(subject_subset, file = "4-Keep-indiv-test-output",row.names = FALSE, sep = "\t", quote = FALSE)
write.table(MAF_filtered$Predictor, file = "4-Keep-SNP-test-output",row.names = FALSE, quote = FALSE)
